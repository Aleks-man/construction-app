...
- Project member management with user creation, contact details, assignment and removal
- Admin user management page with role filters, contact details, user creation and deletion
